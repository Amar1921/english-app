  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto' }}>
      ...
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, color: '#F59E0B', fontSize: 12, fontWeight: 700 }}>
            <BoltRounded sx={{ fontSize: 14 }} /> +{lesson.xpReward} XP
          </Box>
        </Box>
          ...
          <Box sx={{
            ...
            {lesson.vocabulary.map((v, i) => (
              <Box key={i} sx={{
                ...
                <Box sx={{
                  width: 4, height: '100%', minHeight: 20,
                  bgcolor: meta.color, borderRadius: 2, flexShrink: 0, mt: 0.3,
                }} />
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  <Typography sx={{ fontWeight: 700, fontSize: 13, fontFamily: 'monospace', color: meta.color }}>
                    {v.en}
                  </Typography>
      ...
      {lesson.irregularVerbs && (
        <Section title="Verbes irréguliers essentiels" icon="⚡" mb>
          <Box sx={{ overflowX: 'auto' }}>
            <Table size="small">
              <TableHead>
